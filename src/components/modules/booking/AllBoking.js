                            ...
                            <table className="table aiz-table mb-0 footable footable-1 breakpoint-xl" style={{}}>
                                <thead>
                                    <tr className="footable-header">
                                        ...
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Check-in </th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Check-out</th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Nights</th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Adults</th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Children</th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Total</th>
                                        <th className="text-right footable-last-visible" style={{ display: 'table-cell' }}>Status</th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Added on </th>
                                        <th data-breakpoints="md" style={{ display: 'table-cell' }}>Updated on </th>
