  ...
  const [body,setBody] = useState("")
    ...
    return (
        ...
        <div className="card">
                <div className="card-header">
                  <h5 className="mb-0 h6 ">Manual Payment Method 1</h5>
                </div>
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-9">
                        <input
                          type="hidden"
                          name="types[]"
                          defaultValue="manual_payment_1_activation"
                        />
                        <label className="aiz-switch aiz-switch-success mb-0">
                          <input
                            defaultValue={1}
                            name="manual_payment_1_activation"
                            type="checkbox"
                            defaultChecked
                          />
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-9">
                        <input
                          type="hidden"
                          name="types[]"
                          defaultValue="manual_payment_1_name"
                        />
                        <input
                          type="text"
                          className="form-control"
                          name="manual_payment_1_name"
                          defaultValue="Hillary Jennings"
                          placeholder="Name"
    ...
    />
                        {/* <input
                          type="hidden"
                          name="types[]"
                          defaultValue="manual_payment_1_instruction"
                        />
                        <textarea
                          className="aiz-text-editor form-control"
                          name="manual_payment_1_instruction"
                              ...
                              <div className="modal-content">
                                ...
                                <div className="modal-body">
                                  <div className="form-group note-form-group">
                                    <label
                                      htmlFor="note-dialog-link-txt-16775762239741"
                                      className="note-form-label"
                                    >
                                      Text to display
                                    </label>
                                    <input
                                      id="note-dialog-link-txt-16775762239741"
                                  ...
                                  <div className="form-group note-form-group">
                                    <label
                                      htmlFor="note-dialog-link-url-16775762239741"
                                      className="note-form-label"
                                    >
                                      To what URL should this link go?
                                    </label>
                                    <input
                                      id="note-dialog-link-url-16775762239741"
                              ...
                              <div className="modal-content">
                                ...
                                <div className="modal-body">
                                  <div className="form-group note-form-group note-group-select-from-files">
                                    <label
                                      htmlFor="note-dialog-image-file-16775762239741"
                                      className="note-form-label"
                                    >
                                      Select from files
                                    </label>
                                    <input
                                      id="note-dialog-image-file-16775762239741"
                                  ...
                                  <div className="form-group note-group-image-url">
                                    <label
                                      htmlFor="note-dialog-image-url-16775762239741"
                                      className="note-form-label"
                                    >
                                      Image URL
                                    </label>
                                    <input
                                      id="note-dialog-image-url-16775762239741"
                              ...
                              <div className="modal-content">
                                ...
                                <div className="modal-body">
                                  <div className="form-group note-form-group row-fluid">
                                    <label
                                      htmlFor="note-dialog-video-url-16775762239741"
                                      className="note-form-label"
                                    >
                                      Video URL{" "}
                                    ...
                                    <input
                                      id="note-dialog-video-url-16775762239741"
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-9">
                        <input
                          type="hidden"
                          name="types[]"
                          defaultValue="manual_payment_1_image"
                        />
                        <div
