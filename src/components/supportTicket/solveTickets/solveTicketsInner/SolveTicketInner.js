        ...
        <div className="px-15px px-lg-25px">
          <div className="card">
            <div className="card-header">
              <h1 className="page-title h6">A doloribus aut quae</h1>
              <ul className="list-inline small text-muted mb-0">
                <li className="list-inline-item">20210418-073742</li>
                <li className="list-inline-item text-muted">•</li>
                <li className="list-inline-item">2021-04-18 09:37:42</li>
                <li className="list-inline-item text-muted">•</li>
            ...
            <div className="card-body">
              <div className>
                <form
                  ...
                  noValidate
                  name="chat-form"
                  action="https://weddemoadmin.abaris.in/support/support-ticket/agent/reply"
                  method="POST"
...
<ReactQuill
    ...
    modules={SolveTicketInner.modules}
    formats={SolveTicketInner.formats}
    onChange={handleBody}
    value={body}
    />
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group">
                                <label
                                  htmlFor="note-dialog-link-txt-16772454879141"
                                  className="note-form-label"
                                >
                                  Text to display
                                </label>
                                <input
                                  id="note-dialog-link-txt-16772454879141"
                              ...
                              <div className="form-group note-form-group">
                                <label
                                  htmlFor="note-dialog-link-url-16772454879141"
                                  className="note-form-label"
                                >
                                  To what URL should this link go?
                                </label>
                                <input
                                  id="note-dialog-link-url-16772454879141"
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group note-group-select-from-files">
                                <label
                                  htmlFor="note-dialog-image-file-16772454879141"
                                  className="note-form-label"
                                >
                                  Select from files
                                </label>
                                <input
                                  id="note-dialog-image-file-16772454879141"
                              ...
                              <div className="form-group note-group-image-url">
                                <label
                                  htmlFor="note-dialog-image-url-16772454879141"
                                  className="note-form-label"
                                >
                                  Image URL
                                </label>
                                <input
                                  id="note-dialog-image-url-16772454879141"
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group row-fluid">
                                <label
                                  htmlFor="note-dialog-video-url-16772454879141"
                                  className="note-form-label"
                                >
                                  Video URL{" "}
                                ...
                                <input
                                  id="note-dialog-video-url-16772454879141"
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <div className="form-group d-flex">
                        <div
                          className="align-self-baseline input-group-sm"
...
{/* </div> */}
          ...
          <Button variant="primary" onClick={handleClose}>
            Save Changes
                        ...
                        <div className="file-preview box sm flex-grow-1 ml-3" />
                      </div>
                    </div>
              ...
              <ul className="list-group mb-0 mt-4">
                <li className="list-group-item py-3">
                  <div className="media">
                    <span className="avatar avatar-sm mr-3 flex-shrink-0">
                      <img src="https://weddemoadmin.abaris.in/public/uploads/all/NiLOYq4Y5Lap1Ek7QrZcpgXq6UGwcOGpd5RQoOMA.jpg" />
                    </span>
                    <div className="media-body">
                      <div className="mb-3 mb-sm-0">
                        <div className="mb-2">
                          <h1 className="d-inline-block h6 my-0">
                            <a className="d-block mb-0" />
                          </h1>
                      ...
                      <div />
                      <div className="file-preview box clearfix"></div>
                    </div>
                  </div>
                </li>
                <li className="list-group-item py-3">
                ...
                <li className="list-group-item py-3">
                  <div className="media">
                    <span className="avatar avatar-sm mr-3 flex-shrink-0">
                      <img src="https://weddemoadmin.abaris.in/public/uploads/all/zo8WHvxlUyiPrxwnrc6ztQE5u8MnJo2ej2UUl1JU.png" />
                    </span>
                    <div className="media-body">
                      <div className="mb-3 mb-sm-0">
                        <div className="mb-2">
                ...
                <li className="list-group-item py-5">
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <div>
                        <p>hashbcbusigfuibc</p>
                      </div>
                      <div className="file-preview box clearfix">
                        <div
                          className="mt-2 file-preview-item"
                          title="uploads/all/5FYcvX13ztXryKSnvujppUEI9z2L54SaLfS1dJog.jpg"
                        >
                          <a
                            href="https://weddemoadmin.abaris.in/aiz-uploader/download/170"
                            target="_blank"
                            className="d-block"
                          >
                            <div className="thumb">
                              <img
                                src="https://weddemoadmin.abaris.in/public/uploads/all/5FYcvX13ztXryKSnvujppUEI9z2L54SaLfS1dJog.jpg"
                                className="img-fit"
                              />
                            </div>
                            <div className="body">
                              <h6 className="d-flex">
                                <span className="text-truncate title">
                                  jonathan-borba-OoJIOP2QLUg-unsplash
                                </span>
...
export default SolveTicketInner;
