        ...
        <div className="px-15px px-lg-25px">
          <div className="card">
            <div className="card-header">
              <h1 className="page-title h6">Cupiditate</h1>
              <ul className="list-inline small text-muted mb-0">
                <li className="list-inline-item">20210629-114300</li>
                <li className="list-inline-item text-muted">•</li>
                <li className="list-inline-item">2021-06-29 01:43:00</li>
                <li className="list-inline-item text-muted">•</li>
...
<ReactQuill
    ...
    modules={Cupiditate.modules}
    formats={Cupiditate.formats}
    onChange={handleBody}
    value={body}
    />
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group">
                                <label
                                  htmlFor="note-dialog-link-txt-16772385252341"
                                  className="note-form-label"
                                >
                                  Text to display
                                </label>
                                <input
                                  id="note-dialog-link-txt-16772385252341"
                              ...
                              <div className="form-group note-form-group">
                                <label
                                  htmlFor="note-dialog-link-url-16772385252341"
                                  className="note-form-label"
                                >
                                  To what URL should this link go?
                                </label>
                                <input
                                  id="note-dialog-link-url-16772385252341"
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group note-group-select-from-files">
                                <label
                                  htmlFor="note-dialog-image-file-16772385252341"
                                  className="note-form-label"
                                >
                                  Select from files
                                </label>
                                <input
                                  id="note-dialog-image-file-16772385252341"
                              ...
                              <div className="form-group note-group-image-url">
                                <label
                                  htmlFor="note-dialog-image-url-16772385252341"
                                  className="note-form-label"
                                >
                                  Image URL
                                </label>
                                <input
                                  id="note-dialog-image-url-16772385252341"
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="form-group note-form-group row-fluid">
                                <label
                                  htmlFor="note-dialog-video-url-16772385252341"
                                  className="note-form-label"
                                >
                                  Video URL{" "}
                                ...
                                <input
                                  id="note-dialog-video-url-16772385252341"
                    ...
                    <div className="media-body">
                      ...
                      <div className="file-preview box clearfix">
                        <div
                          ...
                          title="uploads/all/rmOAUVnxMg3jNxyK2UI4AFEc0zctMBW0Bl5sFOxy.jpg"
                        >
                          <a
                            href="https://weddemoadmin.abaris.in/aiz-uploader/download/115"
                            target="_blank"
                            className="d-block"
                          >
                            <div className="thumb">
                              <img
                                src="https://weddemoadmin.abaris.in/public/uploads/all/rmOAUVnxMg3jNxyK2UI4AFEc0zctMBW0Bl5sFOxy.jpg"
                                className="img-fit"
                              />
                            </div>
                            <div className="body">
